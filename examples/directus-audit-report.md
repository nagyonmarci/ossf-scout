# Security Data Snapshot: directus/directus

**Date:** 2026-06-03 | **Commit:** d358376 | **Mode:** Static analysis only (no AI synthesis)

---

## CI/CD

### Unpinned GitHub Actions (`uses: action@vX` tags)
...
### Path traversal (readFile / path.join)
...
### Deserialization (yaml.load / JSON.parse)
...
### Security config (helmet / cors / session)
...
### Startup validation (SECRET / env enforcement)
...
### Recently changed files (last 10 commits)
