...
const PROVIDER_MODELS: Record<string, { id: string; label: string; hint: string; inputRate: number; outputRate: number }[]> = {
  ...
  openai: [
    { id: 'gpt-4.1',      label: 'GPT-4.1 (long context)',       hint: '~$0.09–$0.35/run · 30K TPM (T1)',   inputRate: 2.0,  outputRate: 8.0  },
    { id: 'gpt-4.1-mini', label: 'GPT-4.1 mini (long context)',  hint: '~$0.02–$0.07/run · 200K TPM (T1)',  inputRate: 0.40, outputRate: 1.60 },
    { id: 'gpt-4.1-nano', label: 'GPT-4.1 nano (long context)',  hint: '~$0.005–$0.02/run · 200K TPM (T1)', inputRate: 0.10, outputRate: 0.40 },
